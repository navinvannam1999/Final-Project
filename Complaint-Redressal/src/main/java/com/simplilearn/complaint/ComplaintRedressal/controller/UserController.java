...
import com.simplilearn.complaint.ComplaintRedressal.entities.Role;
import com.simplilearn.complaint.ComplaintRedressal.entities.User;
import com.simplilearn.complaint.ComplaintRedressal.entities.UserRole;
import com.simplilearn.complaint.ComplaintRedressal.service.UserService;
...
public class UserController {
	...
	public void createAdmin() {
		User admin = new User();
		admin.setUsername("admin07@abc.com");
		admin.setPassword("admin@abc");
		admin.setFirstName("Navin");
		admin.setLastName("Vannam");
		admin.setEmail("navinvannam24@gmail.com");
